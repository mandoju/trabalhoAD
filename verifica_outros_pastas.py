    ...
    for q in range(numero_ciclos):
        ...
        while (1):
            ...
            while(entrada == 0):
                ...
                if(servidor == 0 ):
                    tempo_entre_entrada_vazio +=  int(lambda_tempo)
                    total_vazio += 1
                    if(resto > 1):
                        tempo_entre_entrada_vazio += 1
                        total_vazio += 1
    ...
    for q in range(numero_ciclos):
        ...
        while (1):
            ...
            while(entrada == 0):
                ...
                if(servidor == 0 ):
                    tempo_entre_entrada_vazio +=  uniforme
                    total_vazio += 1
                    if(resto > 1):
                        tempo_entre_entrada_vazio += 1
                        total_vazio += 1
    ...
    for q in range(numero_ciclos):
        ...
        while (1):
            ...
            if(entrada == 0):
                ...
                exponencial_entrada = 1/lambda_entrada
    ...
    for q in range(numero_ciclos):
        ...
        while (1):
            ...
            if(entrada == 0):
                ...
                ##exponencial_entrada = np.random.exponential(1/lambda_entrada)
                exponencial_entrada =  np.random.uniform(50,150)
                entrada = exponencial_entrada ##Gera uma nova entrada exponencial
                fila+= 1
                i += 1
